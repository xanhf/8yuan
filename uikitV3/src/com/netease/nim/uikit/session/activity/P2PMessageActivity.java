...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    public static void start(Context context, String contactId, SessionCustomization customization, IMMessage anchor, String staffName) {
        ...
        intent.putExtra(P2PMessageActivity.staffName, staffName);

        context.startActivity(intent);
    }

    //add by fangzhu ,自定义标题文字
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        titleStr = getIntent().getStringExtra(staffName);
        // 单聊特例话数据，包括个人信息，
        requestBuddyInfo();
