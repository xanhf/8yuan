...
import com.trade.eight.view.picker.comm.util.ConvertUtils;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected View makeHeaderView() {
        ...
        cancelButtonLayoutParams.leftMargin = ConvertUtils.toPx(activity, 20);
        ...
        submitButtonLayoutParams.rightMargin = ConvertUtils.toPx(activity, 20);
