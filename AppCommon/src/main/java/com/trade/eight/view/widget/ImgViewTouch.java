/***
 * Source: 		http://spitfire.tistory.com/category/Android%20Dev
 * Prototype：	"Hello, Android! 3e" - Touchv3-> Touch.java
 */
...
public class ImgViewTouch extends ImageView {
    ...
    private static final String TAG = "ImgViewTouch";
    ...
    private int realDeleteHeight = 0;
    ...
    public void setImageBitmap(Bitmap bm) {
        ...
        isInit = false;
        if (isInit == false && !(this.getWidth() == 0 && this.getHeight() == 0)) {
            init();
            isInit = true;
        }
    }
...
//		value[5] = (float) height / 2 - (float) scaleHeight / 2;
        ...
        value[2] = (float) width;
        value[5] = (float) height - realDeleteHeight;
    ...
    public int getRealDeleteHeight() {
        return realDeleteHeight;
    }

    public void setRealDeleteHeight(int realDeleteHeight) {
        this.realDeleteHeight = realDeleteHeight;
    }
