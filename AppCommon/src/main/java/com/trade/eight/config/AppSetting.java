...
public class AppSetting {
    ...
    public long getRefreshTimeWPHoldOrder() {
        SharedPreferences sp = context.getSharedPreferences("user_info",
                PreferenceActivity.MODE_PRIVATE);
        return sp.getLong("RefreshTimeWPHoldOrder", 3000L);
    }

    //平仓产品刷新时间
    public long getRefreshTimeWPCloseOrder() {
        SharedPreferences sp = context.getSharedPreferences("user_info",
                PreferenceActivity.MODE_PRIVATE);
    ...
    //账户信息刷新时间
    public void setRefreshTimeTradeInfo(long time) {
        SharedPreferences sp = context.getSharedPreferences("user_info",
                PreferenceActivity.MODE_PRIVATE);
        Editor editor = sp.edit();
        editor.putLong("RefreshTimeTradeInfo", time);
        editor.commit();
    }

    //账户信息刷新时间
    public long getRefreshTimeTradeInfo() {
        SharedPreferences sp = context.getSharedPreferences("user_info",
                PreferenceActivity.MODE_PRIVATE);
        return sp.getLong("RefreshTimeTradeInfo", 3000L);
    }
