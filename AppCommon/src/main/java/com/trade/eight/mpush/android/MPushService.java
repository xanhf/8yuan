...
package com.trade.eight.mpush.android;
...
import com.trade.eight.mpush.api.Client;
import com.trade.eight.mpush.api.ClientListener;
import com.easylife.ten.lib.BuildConfig;
import com.trade.eight.mpush.client.DefaultClientListener;
...
public final class MPushService extends Service implements ClientListener {
    ...
    public static final String ACTION_ORDERNOTIFY = "com.mpush.ORDERNOTIFY";
    public static final String ACTION_QUOTATION = "com.mpush.quotation";
    ...
    public static final String EXTRA_ORDERNOTIFY = "ordernotify";
    public static final String EXTRA_QUOTATION = "quotation";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(((DefaultClientListener)(MPush.I.getClientConfig().getClientListener())).getListener()==null){
            MPush.I.checkInit(this).create(this);
        }
        if (MPush.I.hasStarted()) {
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.e("mpush","MPushService======onDestroy");
    ...
    @Override
    public void onOrderNotify(OrderNotifyData orderNotifyData) {
        sendBroadcast(new Intent(ACTION_ORDERNOTIFY)
                .addCategory(BuildConfig.APPLICATION_ID)
                .putExtra(EXTRA_ORDERNOTIFY, orderNotifyData));
    }

    @Override
    public void onReceiveQuotation(Optional optional) {
        sendBroadcast(new Intent(ACTION_QUOTATION)
                .addCategory(BuildConfig.APPLICATION_ID)
                .putExtra(EXTRA_QUOTATION, optional));
    }
