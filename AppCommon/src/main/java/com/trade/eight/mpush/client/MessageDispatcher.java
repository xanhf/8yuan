...
import com.trade.eight.mpush.api.MessageHandler;
import com.trade.eight.mpush.api.PacketReceiver;
...
import com.trade.eight.mpush.handler.*;
...
public final class MessageDispatcher implements PacketReceiver {
    ...
    public MessageDispatcher() {
        ...
        register(Command.Quotation, new QuotationMessageHandler());
        register(Command.OrderNotify, new OrderNotifyHandler());
