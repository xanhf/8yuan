...
import com.trade.eight.mpush.api.ack.AckCallback;
import com.trade.eight.mpush.api.ack.AckContext;
...
import com.trade.eight.mpush.api.push.PushContext;
import com.trade.eight.mpush.handler.HttpProxyHandler;
import com.trade.eight.mpush.message.*;
...
import com.trade.eight.mpush.util.thread.ExecutorManager;
...
import static com.trade.eight.mpush.api.Constants.MAX_HB_TIMEOUT_COUNT;
...
/*package*/final class MPushClient implements Client, AckCallback {
    ...
    @Override
    public void sendQuotationMessage(String codes) {

        if(!connection.isConnected()){
            return;
        }

        QuotationMessage quotationMessage = new QuotationMessage(connection);
        quotationMessage.setCodes(codes);
        quotationMessage.encodeBody();
        quotationMessage.send();
