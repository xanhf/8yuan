...
import com.trade.eight.camera.utils.CameraHost.FailureReason;
import com.trade.eight.camera.view.DrawingFocusView;
...
{
    static final String TAG = "Cos-Camera";
    ...
    public static interface onCameraFocusChangeListener
    {
...
//                        }
    ...
    public void initPreview(int w , int h , boolean firstRun)
    {
        if (camera != null)
        {
            ...
            // {
            // parameters.setRecordingHint(getHost().getRecordingHint() !=
            // CameraHost.RecordingHint.STILL_ONLY);
            // }
            requestLayout();
