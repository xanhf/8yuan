...
//        if(!useFrontFacingCamera())
        {
            return (CameraUtils.getBestPictureSize(parameters,ctxt));
        }
//        else
//        {
...
//        }
    ...
    {
        photoDirectory = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "Auth");
        // Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM,"MyCameraApp");
    }
