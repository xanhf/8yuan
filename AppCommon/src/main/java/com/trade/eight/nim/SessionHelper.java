...
import com.trade.eight.nim.extension.SnapChatAttachment;
import com.trade.eight.nim.extension.StickerAttachment;
import com.trade.eight.nim.viewholder.MsgViewHolderAutoReply;
import com.trade.eight.nim.viewholder.MsgViewHolderFile;
import com.trade.eight.nim.viewholder.MsgViewHolderSticker;
...
public class SessionHelper {
     ...
     * @param account
     */
    public static void startP2PSession(Context context, String account, String staffName) {
        startP2PSession(context, account, null, staffName);
    }

    public static void startP2PSession(Context context, String account, IMMessage anchor, String staffName) {
...
//        }
        NimUIKit.startChatting(context, account, SessionTypeEnum.P2P, getP2pCustomization(), anchor, staffName);
    ...
    public static void startTeamSession(Context context, String tid, IMMessage anchor) {
        NimUIKit.startChatting(context, tid, SessionTypeEnum.Team, getTeamCustomization(), anchor, null);
    }
...
//        NimUIKit.registerTipMsgViewHolder(MsgViewHolderTip.class);
        ...
        NimUIKit.registerMsgItemViewHolder(AutoReplyAttachment.class, MsgViewHolderAutoReply.class);
