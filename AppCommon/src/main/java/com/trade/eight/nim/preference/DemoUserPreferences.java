package com.trade.eight.nim.preference;
 ...
 * copy from demo  check by fangzhu
 */
public class DemoUserPreferences {
    ...
    public static final String KEY_USER_SALEACCID = "";
    /**
     * add by fangzhu
     * @param key
     * @param value
     ...
     * @param saleAccId
     */
    public static void setStaffAccid(String saleAccId) {
        saveString(KEY_USER_SALEACCID, saleAccId);
    }

    public static String getStaffAccid() {
