...
public class TradeHistoryCloseAdapter extends ArrayAdapter<TradeOrder> {

    List<TradeOrder> objects;
    Context context;

    public TradeHistoryCloseAdapter(Context context, int resource, List<TradeOrder> objects) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        text_tr_junjia.setText(tradeOrder.getPrice());
        ...
        line_tr_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TradeOrderCloseDetailAct.startAct(context,tradeOrder);
            }
        });
