...
public class TradeClose4ProductAdapter extends ArrayAdapter<TradeOrder>{
    ...
    public TradeClose4ProductAdapter(Context context, int resource, List<TradeOrder> objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.item_tradeclose_product, null);
        }
